...
const PredictionForm = () => {
  ...
  const handleChange = (e) =>
    setFormData({ ...formData, [e.target.name]: e.target.value }); // 🔎 Highlight important keywords
  ...
  const runPrediction = async () => {
    ...
    try {
      ...
      setReasons(res.data.final_reasons || []); // ✅ Save loan record automatically
            ...
            <div className="flex justify-center items-center space-x-2">
              ...
              <div className="relative group cursor-pointer">
                ...
                <div className="absolute bottom-full mb-2 hidden group-hover:block w-56 bg-black text-white text-xs rounded-lg p-2 shadow-lg">
                  Rule-based adjustments may override model
                  output. {" "}
                </div>
                {" "}
              </div>
